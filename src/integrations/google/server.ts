...
export function init(server: express.Express) {
  ...
  server.get('/api/google/login_url', async (_req: express.Request, res: express.Response) => {
  ...
  server.get('/api/google/info', async (req: express.Request, res: express.Response) => {
    const code = req.query.code;
    logger.info(`☘️ Getting Google token`, code);
  ...
  server.get('/api/google/calendar/events/:integrationId', async (req: express.Request, res: express.Response) => {
