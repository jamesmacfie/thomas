...
const IntegrationsWidgetPlugin = require('../.thomas/build');
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        thomas: path.resolve(__dirname, '../src/ui/.thomas/'),
        utils: path.resolve(__dirname, '../src/ui/utils/'),
        validations: path.resolve(__dirname, '../src/ui/validations/'),
