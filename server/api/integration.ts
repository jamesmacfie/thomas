...
const init = (server: express.Express) => {
  server.post('/integration', async (req: express.Request, res: express.Response) => {
    try {
  ...
  server.patch('/integration/:integrationId', async (req: express.Request, res: express.Response) => {
    try {
  ...
  server.get('/integrations', async (_req: express.Request, res: express.Response) => {
    try {
  ...
  server.get('/integrations/:slug', async (req: express.Request, res: express.Response) => {
