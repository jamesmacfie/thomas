...
const init = (server: express.Express) => {
  server.get('/configs', async (_req: express.Request, res: express.Response) => {
    try {
  ...
  server.get('/config/:slug', async (req: express.Request, res: express.Response) => {
  ...
  server.patch('/config/:slug', async (req: express.Request, res: express.Response) => {
    const slug = req.params.slug;
    try {
  ...
  server.post('/config', async (req: express.Request, res: express.Response) => {
    try {
